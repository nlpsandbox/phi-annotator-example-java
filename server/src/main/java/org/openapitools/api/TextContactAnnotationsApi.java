        ...
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"textContactAnnotations\" : [ { \"start\" : 42, \"length\" : 11, \"text\" : \"dave@uw.edu\", \"contactType\" : \"email\", \"confidence\" : 95.5 }, { \"start\" : 42, \"length\" : 11, \"text\" : \"dave@uw.edu\", \"contactType\" : \"email\", \"confidence\" : 95.5 } ] }";
